...
use App\DataImport\Infrastructure\Persistence\Doctrine\Repository\EtoroDividendRecordRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bridge\Doctrine\Types\UuidType;
use Symfony\Component\Uid\Uuid;

#[ORM\Entity(repositoryClass: EtoroDividendRecordRepository::class)]
#[ORM\Table(name: 'etoro_dividends')]
#[ORM\UniqueConstraint(name: 'uniq_etoro_dividends_job_hash', columns: ['import_job_id', 'row_hash'])]
class EtoroDividendRecord
{
    #[ORM\Id]
