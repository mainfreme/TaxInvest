...
use App\DataImport\Infrastructure\Persistence\Doctrine\Repository\EtoroClosedPositionRecordRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bridge\Doctrine\Types\UuidType;
use Symfony\Component\Uid\Uuid;

#[ORM\Entity(repositoryClass: EtoroClosedPositionRecordRepository::class)]
#[ORM\Table(name: 'etoro_closed_positions')]
#[ORM\UniqueConstraint(name: 'uniq_etoro_closed_positions_job_hash', columns: ['import_job_id', 'row_hash'])]
class EtoroClosedPositionRecord
{
    #[ORM\Id]
